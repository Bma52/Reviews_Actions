...
def insert_to_mysql(df_product, df_reviews, df_annotation):
    ...
    frame_product = df_product.to_sql("Products", dbConnection, if_exists='replace')
    ...
    frame_review = df_reviews.to_sql("Reviews", dbConnection, if_exists='replace')
    ...
    frame_annotation = df_annotation.to_sql("Annotation", dbConnection, if_exists='replace')
