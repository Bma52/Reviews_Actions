...
def create_triplets(df, i):
    ...
    if df["Actions"][i] == "No_ActionAction":
       ...
       list_objects = [oa + str(df['annotation_md5'][i]),
                ...
                schema + str(df['reviewBody_md5'][i]),
                schema + str(df['Actions'][i]),
                str(df['Valence'][i]) + “^^”+xsd+”string”,
                str(df['reviewBody'][i]) + “^^”+xsd+”string”,
                oa + str(df['annotation_md5'][i]),
                schema + str(df["Object"][i]),
                schema + str(df['Actions'][i]),
                arec + str(df['Features'][i]),
                schema + str(df["product_name_md5"][i]),
                str(df["ratingValue"][i]) + “^^”+xsd+”decimal”,
                schema + str(df["seller_name"][i]),
                schema + str(df["product_name_md5"][i]),
                str(df["created_timestamp"][i]) + “^^”+xsd+”string”,
                str(df['annotation'][i]) + “^^”+xsd+”string”,
                str(df["product_name"][i]) + “^^”+xsd+”string”,
                str(df["product_name"][i]) + “^^”+xsd+”string”,
                schema + str(df["seller_name"][i]),
                str(df["availability"][i]) + “^^”+xsd+”string”,
                str(df["price"][i]) + “^^”+xsd+”decimal”,
                str(df["priceCurrency"][i]) + “^^”+xsd+”string”,
                str(df["model"][i]) + “^^”+xsd+”string”,
                str(df["product_name"][i]) + “^^”+xsd+”string”,
                str(df["product_name"][i]) + “^^”+xsd+”string”,
                str(df["description"][i]) + “^^”+xsd+”string”,
                str(df["brand_name"][i]) + “^^”+xsd+”string”,
                str(df["url"][i]) + “^^”+xsd+”string”,
                str(df["image"][i]) + “^^”+xsd+”string”,
               ]    
